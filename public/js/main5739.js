...
$(function () {
    ...
    var t, o, a, s, n, r;
    ($(".floated-chat-btn, .floated-chat-w .chat-close").on(
        "click",
        function () {
    ...
    if (
        ($(".mobile-menu-trigger").on("click", function () {
            return (
                $(".menu-mobile .menu-and-user").slideToggle(200, "swing"), !1
            );
        }),
        os_init_sub_menus(),
        $(
            ".content-panel-toggler, .content-panel-close, .content-panel-open"
        ).on("click", function () {
    ...
    $(".task-btn-done").on("click", function () {
        ...
        $(".task-btn-star").on("click", function () {
            return (
                $(this).closest(".draggable-task").toggleClass("favorite"), !1
            );
        }),
        $(".task-btn-delete").on("click", function () {
            if (confirm("Are you sure you want to delete this task?")) {
                ...
                e.addClass("pre-removed"),
                    e.append(
                        '<a href="#" class="task-btn-undelete">Undo Delete</a>'
                    ),
        ...
        $(".search-suggest-input").on("keydown", function (e) {
            27 == e.which && $(".search-with-suggestions-w").fadeOut(),
                (46 != e.which && 8 != e.which) ||
                    ($(
                        ".search-with-suggestions-w .ssg-item:last-child"
                    ).show(),
                    $(
