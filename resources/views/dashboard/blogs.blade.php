                        ...
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <form>
                                    ...
                                    <div class="form-group"><label for=""> Slug</label><input class="form-control"
                                            placeholder="Slug..." type="text" /></div>
                                    <div class="form-group"><label for=""> Creator</label><input
                                            class="form-control" placeholder="Creator..." type="text" /></div>
